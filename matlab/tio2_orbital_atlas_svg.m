...
for k = 1:5
    ...
    hold(ax, 'on');
    orb.angularCloud(ax, names{k}, 22, 32);
...
text(ax2, 0, 0.90, orb.lines('VB hybridization label for CN = 6.', ...
...
text(ax2, 0, 0.58, orb.lines( ...
    'eg (dz2, dx2-y2) point at O and are', ...
    'pushed up; t2g sit between ligands.', ...
...
text(ax2, 0, 0.08, orb.lines('Rutile Ti-O ~ 1.95 / 1.98 A (distortion', ...
...
text(ax2, 0, 0.78, orb.lines( ...
    'Each hybrid is 1/3 s + 2/3 p', ...
    '(Beiser 8.5, L2 ethene/benzene).', ...
    'The leftover 2pz is perpendicular', ...
    'to the plane and pi-donates into', ...
    'Ti t2g - this is the O 2p', ...
